...
Ideally, I would create parquet files by year. However, these date columns aren't in good shape for quick grouping. The csv converted 'MM/DD/YYYY HH:MM:SS' to strings instead of date-objects for R.  
...
tibble(
  ...
  mb = scales::comma(
    file.size(file.path("data/ems-nyc", files)) / 1024^2 
    )
) 

# files                                                size_MB
# <chr>                                                <chr>  
# 1 BOROUGH=BRONX/part-0.parquet                         480    
# 2 BOROUGH=BROOKLYN/part-0.parquet                      573    
# 3 BOROUGH=MANHATTAN/part-0.parquet                     506    
# 4 BOROUGH=QUEENS/part-0.parquet                        416    
# 5 BOROUGH=RICHMOND%20%2F%20STATEN%20ISLAND/part-0.par… 126    
# 6 BOROUGH=UNKNOWN/part-0.parquet                       1  
```
